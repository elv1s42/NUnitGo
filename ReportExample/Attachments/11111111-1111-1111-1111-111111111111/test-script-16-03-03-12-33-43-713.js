                    ...
                    $(function () {
                        $('#history-11111111-1111-1111-1111-111111111111-16-03-03-12-33-43-713').highcharts('StockChart', {       		
           	                chart: {
            		                type: 'spline'
        		                },        		
                            rangeSelector: {
                           ...
                           plotOptions: {
                            ...
                            [{
                                ...
                                name: 'Screenshots',
                                type: 'flags',
                                data: [{ x: Date.UTC(2016, 03, 03, 12, 31, 54), title: 'img', text: 'Screenshot'},{ x: Date.UTC(2016, 03, 03, 12, 32, 58), title: 'img', text: 'Screenshot'},{ x: Date.UTC(2016, 03, 03, 12, 33, 43), title: 'img', text: 'Screenshot'},],
                                shape: 'flag',
                                width: 16,
                                fillColor : '#D6FAF7',
                                color : '#CCEBE8'
