                    ...
                    $(function () {
                        $('#history-11111111-1111-1111-1111-111111111113-16-03-03-12-50-34-757').highcharts('StockChart', {       		
           	                chart: {
            		                type: 'spline'
        		                },        		
                            rangeSelector: {
                           ...
                           plotOptions: {
                            ...
                            [{
                                ...
                                name: 'Test durtion',
                                type: 'spline',
                                data: [{ x: Date.UTC(2016, 03, 03, 12, 49, 27), y: 0.9580958, marker:{ fillColor: '#ffc107'}, url: 'test-16-03-03-12-49-27-625.html'},{ x: Date.UTC(2016, 03, 03, 12, 50, 34), y: 0.9050905, marker:{ fillColor: '#ffc107'}, url: 'test-16-03-03-12-50-34-757.html'},],
                                id: 'dataseries',
                                tooltip: {
                                    valueDecimals: 4
                                },
